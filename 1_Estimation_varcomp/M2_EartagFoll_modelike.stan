...
// on visit duration at the feeder of group-housed pigs, and calculate the pointwise log-likelihood
// 
...
// The parameters  of the model= beta: locations, weight, hour entry,sigma_eartag,sigma_follower,sigma_e.
parameters {
...
model {   
  // priors for beta(locations,weight, hour entry) ~ uniform(-inf, inf), 
